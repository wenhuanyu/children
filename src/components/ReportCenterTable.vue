    ...
    <div class="content">
        <div class="content_top">
            <div class="content_top_left">
                ...
                <a class="report" href="javascript:;" @click="RiskClick" v-if="RiskEarlywarning" style="color: #20BE18">
                    危险预警报告
                </a>
            </div>
            ...
            <el-table-column v-if="setting" :label="operation" width="600" align="center">
                <template slot-scope="scope">
                    <div style="display: inline-block;min-width: 100px;" v-if="operationLeft">
                        ...
                        <el-row>
                            <el-button v-if="check('测评报告')" @click="goTestReport(scope.row)" style="background: #20BE18;border: none!important;color: #fff;font-size: 16px">
                                测评报告
                            </el-button>
                            <el-button v-if="check('情绪调节报告')" @click="EmotionDetail(scope.row)" style="background: #FE9834;border: none!important;color: #fff;font-size: 16px">
                                训练治疗报告
                            </el-button>
                        </el-row>
                    </div>
...
::v-deep .el-table .el-table__row:hover > td {
    background-color: #DEF5DD !important;
}
