    ...
    data() {
        return {
            menuList: [
                ...
                {path: '/Toolkit', name: '工具箱', img: require('../assets/images/gjx.png')},
...
.menu {
    ...
    min-width: 290px;
    height: 100%;
    background: url('../assets/images/leftbj.png') no-repeat;
...
.menu a.active {
    background: linear-gradient(-87deg, #00A451 1%, #51BB3B 100%);
}
