  ...
  <div class="top">
    <div class="top_left">
      ...
      <div>
        ...
        <p style="margin-left: 20px;background-color:#DEF5DD;color: #20BE18;" v-if="$route.meta.subtitle">
...
export default {
  ...
  methods: {
      ...
      jump: function (event) {
          ...
          if (e.innerHTML === '儿童智能开发指导') {
              this.$router.push('/SmartGrowth')
          }
          if (e.innerHTML === '儿童膳食营养指导') {
              this.$router.push('/NutritionalGuidance')
          }
          if (e.innerHTML === '儿童发育指导') {
              this.$router.push('/DevelopmentGuidance')
          }
      },
    close() {
