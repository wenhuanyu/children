...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: '/DevelopmentGuidance',
                name: 'DevelopmentGuidance',
                component: () => import( '../views/DevelopmentGuidance.vue'),
                meta: {
                    title: '工具箱',
                    subtitle: '儿童发育指导',
                    parent: '/Toolkit'
            ...
            {
                path: '/DevelopmentGuidanceDetail',
                name: 'DevelopmentGuidanceDetail',
                component: () => import( '../views/DevelopmentGuidanceDetail.vue'),
                meta: {
                    title: '儿童发育指导',
                    subtitle: '儿童发育指导',
                    parent: '/Toolkit'
            ...
            {
                path: '/HeightPrediction',
                name: 'HeightPrediction',
                component: () => import( '../views/HeightPrediction.vue'),
                meta: {
                    title: '工具箱',
                    subtitle: '儿童未来身高预测',
                    parent: '/Toolkit'
            ...
            {
                path: '/NutritionalGuidance',
                name: 'NutritionalGuidance',
                component: () => import( '../views/NutritionalGuidance.vue'),
                meta: {
                    title: '工具箱',
                    subtitle: '儿童膳食营养指导',
                    parent: '/Toolkit'
            ...
            {
                path: '/NutritionalGuidanceDetail',
                name: 'NutritionalGuidanceDetail',
                component: () => import( '../views/NutritionalGuidanceDetail.vue'),
                meta: {
                    title: '儿童膳食营养指导',
                    subtitle: '儿童膳食营养指导',
                    parent: '/Toolkit'
            ...
            },
            {
                path: '/SmartGrowth',
                name: 'SmartGrowth',
                component: () => import( '../views/SmartGrowth.vue'),
                meta: {
                    title: '工具箱',
                    subtitle: '儿童智能开发指导',
                    parent: '/Toolkit'
            ...
            {
                path: '/SmartGrowthDetail',
                name: 'SmartGrowthDetail',
                component: () => import( '../views/SmartGrowthDetail.vue'),
                meta: {
                    title: '儿童智能开发指导',
                    subtitle: '智能开发指导',
                    parent: '/SmartGrowth'
            ...
            {
                path: '/ProprietaryChineseMedicine',
                name: 'ProprietaryChineseMedicine',
                component: () => import( '../views/ProprietaryChineseMedicine.vue'),
                meta: {
                    title: '工具箱',
                    subtitle: '中成药数据库查询',
                    parent: '/Toolkit'
    ...
    },
    {
        ...
        children: [
            ...
            {
                path     : '/TerminalDrawingBoard',
                name     : 'TerminalDrawingBoard',
                component: () => import('../views/terminal/TerminalDrawingBoard'),
                meta     : {
                    title: '画板',
                    type : 'terminal'
                }
            },
            {
                path     : '/TerminalHuaBan',
                name     : 'TerminalHuaBan',
                component: () => import('../views/terminal/TerminalHuaBan'),
                meta     : {
                    title: '画板',
                    type : 'terminal'
                }
