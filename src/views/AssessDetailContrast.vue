    ...
    <div class="content">
        <div class="content_top">
            ...
            <div>
                ...
                <el-button type="warning" @click="dialogPrint = true" icon="el-icon-s-tools" style="background-color: #FE9834; border-color: #FE9834;">
                    打印设置
                </el-button>
        ...
        <div class="content_body">
            <div class="print_html" ref="print" id="print">
                ...
                <div class="table-name">
                    ...
                    <div>
                        <p class="no-print"><span class="edit-btn" @click="xiu" v-if="isShow"><i
                            class="el-icon-edit"></i>修改报告</span></p>
                    </div>
                ...
                <div class="print-body">
                    ...
                    <div class="flex" style="border-bottom: 1px solid #e6e6e6; padding: 10px 25px;" v-if="form.calc_name == 'Gesell'">
                    ...
                    <div v-if="showBar=printData[0].value && form.calc_name =='DPT'"
                         style="display: flex;justify-content: center;flex-direction:column;align-items: center;padding-left: 0;padding-right: 0;">
                        <div class="flex" style="width: 100%">
                            <div style="width: 50%; padding: 15px 25px; border-right: 1px solid #E6E6E6;border-bottom: 1px solid #E6E6E6" v-if="showBar=printData[0].value">
                                <img :src=form.image style="width: 100%; height: auto; margin: 0 auto;display: block;">
                            </div>
                            <div style="width: 50%; padding: 15px 25px;border-bottom: 1px solid #E6E6E6" v-if="showBar=printData[0].value">
                                <img :src=form1.image style="width: 100%; height: auto; margin: 0 auto;display: block;">
                            </div>
                        </div>
                        <div v-if="form.calc_name =='DPT'" class="flex" style="width: 100%;border-bottom: 1px solid #E6E6E6">
                            <div style="width: 50%" v-if="showBar=printData[2].value">
                                ...
                                <div class="flex" style="text-align: center; font-size: 16px; line-height: 36px; font-weight: bold; border-bottom: 1px solid #e6e6e6;"
                                     v-for="(item,index) in form.answer_detail" :key="index" v-if="item.title !=='合计' ">
                                ...
                                <div class="flex" style="text-align: center; font-size: 18px; line-height: 54px; font-weight: bold; ">
                                    ...
                                    <div style="width: 22%;border-left: 1px solid #e6e6e6;">{{ form.answer_detail[form.answer_detail.length-1].total_score }}</div>
                                    <div style="width: 22%;border-left: 1px solid #e6e6e6;">{{ form.answer_detail[form.answer_detail.length-1].get_score }}</div>
                                </div>
                            </div>
                            <div style="width: 50%" v-if="showBar=printData[2].value">
                                <div class="flex" style="text-align: center; font-size: 18px; line-height: 54px; font-weight: bold; border-bottom: 1px solid #e6e6e6;">
                                ...
                                <div class="flex" style="text-align: center; font-size: 16px; line-height: 36px; font-weight: bold; border-bottom: 1px solid #e6e6e6;"
                                     v-for="(item,index) in form1.answer_detail" :key="index" v-if="item.title !=='合计' ">
                                    <div style="width: 22%;border-left: 1px solid #e6e6e6;">{{ item.num }}</div>
                                    <div style="width: 34%;border-left: 1px solid #e6e6e6;">{{ item.title }}</div>
                                    <div style="width: 22%;border-left: 1px solid #e6e6e6;">{{ item.total_score }}</div>
                                    <div style="width: 22%;border-left: 1px solid #e6e6e6;">{{ item.get_score }}</div>
                                ...
                                <div class="flex" style="text-align: center; font-size: 18px; line-height: 54px; font-weight: bold; ">
                                    <div style="width: 56%;border-left: 1px solid #e6e6e6;">总计</div>
                                    <div style="width: 22%;border-left: 1px solid #e6e6e6;">{{ form1.answer_detail[form1.answer_detail.length-1].total_score }}</div>
                                    <div style="width: 22%;border-left: 1px solid #e6e6e6;">{{ form1.answer_detail[form1.answer_detail.length-1].get_score }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="print-row" v-if="showBar=printData[0].value && form.calc_name !=='DPT'"
                         style="display: flex;justify-content: center;flex-direction:column;align-items: center;padding-left: 0;padding-right: 0;">
                    ...
                    <div class="print-row2" style="padding-top:20px;" v-if="showBar = printData[2].value && form.calc_name !=='DPT'">
                        <div class="table-name">
                            <p></p>
                        ...
                        <div class="flex" style="border-top: 1px solid #E6E6E6; border-bottom: 1px solid #E6E6E6;">
                            <div class="report-text-content" style="width:50%; border-right: 1px solid #E6E6E6; padding-left:55px; padding-top:30px; padding-bottom:30px;">
                                <div v-for="item in form.yinzi_lst" class="margin-20 no-margin-left no-margin-right no-margin-right">
                                    ...
                                    <div v-html="item.desc" style="width: 460px;"></div>
                                </div>
                            </div>
