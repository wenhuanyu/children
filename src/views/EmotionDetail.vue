...
<!--                    </div>-->
                    ...
                    <div class="print-row" style="padding: 30px" v-if="showBar=printData[1].value">
                        <div class="table-name">
                            ...
                            <div>
                                <p class="no-print">
                                    <span class="edit-btn"  v-show="isShow" @click="conclusion = true"><i
...
<!--                        </div>-->
                        <div style="margin-top: 50px;">
                            <div style="width: 900px;" v-if="item.status" v-for="(item,index) in form.conclusion.list" :key="index" class=" flex flex-justify-content-between text-left size-22 margin-5 no-margin-left no-margin-top no-margin-right">
                                <div style="font-weight: 400" v-html="item.title"></div>
                                <div  style="font-weight: 400; width: 500px;" v-html="item.game_name" ></div>
                    ...
                    <div class="print-row" style="padding: 30px" v-if="showBar = printData[2].value">
                        <div class="print-row">
                            <div class="table-name">
                                ...
                                <div>
                                    <p class="no-print">
                                        <span class="edit-btn" v-if="isShow" @click="getProposal({title:'医生建议',type:9,field:'doctor_proposal'})"><i
                                            class="el-icon-edit"></i>点击此处修改</span>
                                    </p>
                                </div>
...
<!--                            <textarea ref="test_one" class="report-text-content"  v-html="doctor_proposal" style="height: 0"></textarea>-->
        ...
        <el-dialog class="new-dialog text-dialog" title="结论" :visible.sync="conclusion" width="50%">
            <div style="width: 100%;">
...
export default {
    ...
    methods:{
        ...
        // 结论确定按钮
        queding() {
            console.log('this.concl_list',this.concl_list)
