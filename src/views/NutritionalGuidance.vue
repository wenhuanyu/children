<template>
    <div class="content_body">
        ...
        <span style="margin-left: 30px;">请选择指导方向</span>
...
export default {
    ...
    methods: {
        onWeek() {
            this.$axios.post('api/tool/diet_age_lst').then(res => {
                if (res.data.code === 1) {
        ...
        weekInfo(){
            ...
            this.$router.push({name:'NutritionalGuidanceDetail', query:{age:this.week_id,type:this.week_id_}})
        }
    },
}
</script>
