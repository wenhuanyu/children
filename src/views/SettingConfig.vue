<template>
    <div class="content">
        <div class="content_top">
            <a class="report" href="javascript:;"  style="color: #20BE18" @click="beifen">
        ...
        <div class="content_body">
            <div class="row">
                ...
                <el-upload
                    ...
                    <el-button type="warning" round style="background-color: #00D2B2; border-color: #00D2B2" >上传图标</el-button>
                </el-upload>
        ...
        <el-dialog :visible.sync="qrDialog" :modal="false" width="22vw" top="25vh" :close-on-click-modal="false">
            <div class="dialog-body">
                <div class="dialog-text" style="text-align: center">
                    ...
                    <el-button type="warning" style="background: #20BE18;border: 1px solid #20BE18;color: #FFFFFF;box-shadow:none;" round @click="qrDialog = false">知道了
                    </el-button>
                </div>
            </div>
